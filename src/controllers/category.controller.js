import {
  getAllCategory, //Servicio que devuelve todas las categorias
...
export const getCategory = async (req, res) => {
  try {
    ...
    res.send({ status: "ok", description: "Lista de Categorias", data: cate });
  } catch (error) {}
};
...
export const postCategory = async (req, res) => {
  try {
    ...
    //se invoca el servicio para registrar una categoria
